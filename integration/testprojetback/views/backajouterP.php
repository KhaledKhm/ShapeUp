...
//horloge code end
      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Ajouter une Promotion</h2>
              </div>
            </div>
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="ajouterPromotion.php" class="tm-edit-product-form" method="POST">
                  ...
                  <div class="form-group mb-3">
                   ...
                   <div class="form-group mb-3 col-xs-12 col-sm-6">
                    ...
                    <select name="idProduit" id="idProduit" class="custom-select tm-select-accounts">
                    <?PHP
                  		include "../entities/promotion.php";
				              include "../core/promotionC.php";
				              $promotion1C= new promotionC();
				              $listefk=$promotion1C->recupererfk();
              ...
              <div class="col-12">
                <button id="ajouter" type="submit" class="btn btn-primary btn-block text-uppercase">Ajouter Promotion</button>
              </div>
            </div>
          </div>
        </div>
  ...
  <script type="text/javascript">
  	var sub=document.getElementById("ajouter");
