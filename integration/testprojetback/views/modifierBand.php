...
<html lang="en">
  <head>
    ...
    <title>Modifier un Band d'achats</title>
    <link
      rel="stylesheet"
  ...
  ?>
    <nav class="navbar navbar-expand-xl">
      <div class="container h-100">
        ...
        $bandC=new bandC();
        $result=$bandC->recupererband($_GET["idBand"]);
        foreach($result as $row){
        $idBand=$row['idBand'];
...
//horloge code end
      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Modifier un Band d'achats</h2>
              </div>
            </div>
            <div class="row tm-edit-product-row">
                ...
                <form action="" method="POST" class="tm-edit-product-form">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input
                      ...
                      class="form-control validate"
                      required
                      value="<?PHP echo $tauxBand ?>"
                    />
                  </div>
                  <div class="form-group mb-3">
                    <label
                      for="descriptionBand"
                      >descriptionBand</label
                    >
                    <input
                      id="descriptionBand"
                      ...
                      type="text"
                      required
                      value="<?PHP echo $descriptionBand ?>"
                    ></input>
                  </div>
                  <div class="form-group mb-3">
                    <label
              ...
              <div class="col-12">
                <button type="submit" class="btn btn-primary btn-block text-uppercase " name="modifier" id="modifier">Modifier Band d'achats</button>
              </div>
            </form>
            <?PHP
            }
            ...
            $band=new band($_POST['tauxBand'],$_POST['descriptionBand'],$_POST['cinUtilisateur']);
            $bandC->modifierband($band,$_POST['idBand']);
            // echo $_POST['cin_ini'];
    ...
    var tauxPromotion=document.getElementById("tauxBand");
