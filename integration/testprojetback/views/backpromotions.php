          ...
          <div class="tm-bg-primary-dark tm-block tm-block-products" style="width:1120px; height: 120px">
            <div class="tm-product-table-container">
              ...
              <table class="table table-hover tm-table-small tm-product-table">
                <thead>
                  <tr>
                    <th scope="col">idPromotion</th>
                    <th scope="col">tauxPromotion</th>
                    <th scope="col">descriptionPromotion</th>
                    <th scope="col">idProduit</th>
                    <th scope="col">datedepartPromotion</th>
                    <th scope="col">datefinPromotion</th>
                    <th scope="col">&nbsp;</th>
                    <th scope="col">&nbsp;</th>
                    <th scope="col">&nbsp;</th>
                  </tr>
                ...
                <tbody>
                  ...
                  include "../entities/promotion.php";
				          ...
				          $listepromotions=$promotion1C->recupererliste();
                  foreach($listepromotions as $row){
                  ?>
                  <tr>
                  	<td class="tm-product-name"><?PHP echo $row["idPromotion"]; ?></td>
                  	<td><?PHP echo $row["tauxPromotion"]; ?></td>
                  	<td><?PHP echo $row["descriptionPromotion"]; ?></td>
                  	<td><?PHP echo $row["idProduit"]; ?></td>
                  	<td><?PHP echo $row["datedepartPromotion"]; ?></td>
                  	<td><?PHP echo $row["datefinPromotion"]; ?></td>
                  	<td>
                      <form method="GET">
                      <a href="supprimerPromotion.php?idPromotion=<?PHP echo $row["idPromotion"]; ?>" class="tm-product-delete-link">
                        <i class="far fa-trash-alt tm-product-delete-icon"></i>
                      </a>
                    </td>
                    <td>
                      <a href="modifierPromotion.php?idPromotion=<?PHP echo $row["idPromotion"]; ?>" class="tm-product-delete-link" style="color:#FFFFFF;">
                    ...
                    <td>
                    	<form method="GET">
                    		<a href="phpPDF/PDF.php?idPromotion=<?PHP echo $row["idPromotion"];?>&tauxPromotion=<?PHP echo $row["tauxPromotion"]; ?>&descriptionPromotion=<?PHP echo $row["descriptionPromotion"]; ?>&idProduit=<?PHP echo $row["idProduit"]; ?>&datedepartPromotion=<?PHP echo $row["datedepartPromotion"]; ?>&datefinPromotion=<?PHP echo $row["datefinPromotion"]; ?>" class="tm-product-delete-link" style="color:#FFFFFF;">
            ...
            <!-- table container -->
            <a
              href="backajouterP.php"
              class="btn btn-primary btn-block text-uppercase mb-3">Ajouter une Promotion</a>
          </div>
        </div>
      </div>
    </div>
