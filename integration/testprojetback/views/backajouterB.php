...
<html lang="en">
  <head>
    ...
    <title>Ajouter Band d'achat</title>
    <link
      rel="stylesheet"
      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Ajouter un Band d'achats</h2>
              </div>
            </div>
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="ajouterBand.php" method="POST" class="tm-edit-product-form">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input
                      ...
                      type="text"
                      required
                      placeholder="description du band"
                    ></input>
                  </div>
                   <div class="row">
                   <div class="form-group mb-3 col-xs-12 col-sm-6">
                    ...
                    <select name="cinUtilisateur" id="cinUtilisateur" class="custom-select tm-select-accounts">
                    <?PHP
                      include "../entities/band.php";
                      include "../core/bandC.php";
                      $band1C= new bandC();
                      $listefk=$band1C->recupererfk();
                      foreach($listefk as $row){
                      $code= $row["cinUtilisateur"];
              ...
              <div class="col-12">
                <button type="submit" class="btn btn-primary btn-block text-uppercase" id="ajouter" name="ajouter">Ajouter Band</button>
              </div>
            </form>
            </div>
          </div>
