...
?>
              ...
              <div class="col-12">
                 <button type="submit" name="modifier" class="btn btn-primary btn-block text-uppercase">Modifier La Catégorie</button>
...
if (isset($_POST['modifier'])){
  $categorie=new categorie($_POST['id'],$_POST['libelleC'],$_POST['descriptionC'],$_POST['img']);
