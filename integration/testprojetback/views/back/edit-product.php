...
?>
  ...
  <div class="form-group mb-3">
               ...
               <div class="form-group mb-3">
                 ...
                 <div class="col-12">
                 <button type="submit" name="modifier" class="btn btn-primary btn-block text-uppercase">Modifier Le Produit</button>
...
if (isset($_POST['modifier'])){
  $produit=new produit($_POST['code'],$_POST['libelleP'],$_POST['quantite'],$_POST['prix'],$_POST['id'],$_POST['img']);
