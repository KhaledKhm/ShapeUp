...
<input type="submit" name="chercher" value="chercher"></form>
                  ...
                  <tr>
                   ...
                   <th scope="col"><td><form method="POST" action="triQ.php"> <input type="submit" name="trier"value="Quantité" onclick="notifyMe()" >
                    </form>
                    </td></th>
                    <th scope="col"><td><form method="POST" action="tri.php"> <input type="submit" name="trier"value="Prix" onclick="notifyMe()" >
                    </form>
                    </td></th>
 ...
 <?PHP
  ...
  function notify() {
    var notification = new Notification('Hey', {
      icon: '../../notifier.png',
      body: " opération effectuée avec succès!",
