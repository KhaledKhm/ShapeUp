...
$listeReclamationsFront=$reclamation1C->afficherReclamationsFront();
...
<!-- ******************************************************************** -->
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Vos Réclamations</h2>
          </div>
          <table class="table table-striped">
    <tr>
        <td>Id Reclamation</td>
        <td>Type reclamation</td>
        <td>Texte reclamation</td>
        <td>Etat</td>
        <td>Texte reponse</td>
        <td>Cin</td>
        <td>supprimer</td>
    ...
    foreach($listeReclamationsFront as $row){
        ?>
        <tr>
            ...
            <td><form method="POST" action="frontsupprimerReclamation.php">
                    <input type="submit" name="supprimer" value="supprimer">
                    <input type="hidden" value="<?PHP echo $row['idReclamation']; ?>" name="idReclamation">
                </form>
            </td>
            <td><a href="frontmodifierReclamation.php?idReclamation=<?PHP echo $row['idReclamation']; ?>">
                    Modifier</a></td>
        </tr>
        <?PHP
    }
    ?>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                  <a href="frontreclamation.php" class="mt-5 btn btn-primary btn-block text-uppercase">
