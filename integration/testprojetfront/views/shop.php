 ...
 <header class="site-navbar" role="banner">
      ...
      <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
            ...
            <li class="";><a href="frontreclamation.php">Reclamations</a></li>
            <li><a href="frontappreciation.php">Appreciations</a></li>
            <li class="active"><a href="shop.php">Promotions</a></li>
...
<!--Menu ends here -->
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Promotions</strong></div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div class="row mb-5">
          <div class="col-md-15 order-2">

            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5">Articles en promotion</h2></div>
                <!--<div class="d-flex">
              ...
              <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                <div class="block-4 text-center border">
                  <figure class="block-4-image">
                   <!-- <a href="shop-single.html"><img src="images/produit.jpg" alt="Image placeholder" class="img-fluid"></a>-->
                     <?php
          echo' <img src="data:images/jpeg;base64,'.base64_encode($row['img']).'" alt=""  />';
          ?>
                  </figure>
                  <div class="block-4-text p-4">
                    <h3><a href="shop-single.html"><?PHP echo $row["libelleP"] ?></a></h3>
                    <p class="mb-0"><?PHP echo $row["descriptionPromotion"]?></p>
                    <p class="text-primary font-weight-bold"><?PHP echo $row["prix"]*(100-$row["tauxPromotion"])/100?>DT</p>
                    <p class="text-primary font-weight-bold">en stock :<?PHP echo $row["quantite"]?></p>
                  </div>
                </div>
              </div>
             <?php 
            ...
            <div class="site-section site-blocks-2">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img src="images/musculation.jpg" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
                        <span class="text-uppercase"></span>
                        <h3>Musculation</h3>
                  ...
                  <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
                    <a class="block-2-item" href="#">
                      <figure class="image">
                        <img src="images/spel.jpg" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
                        <span class="text-uppercase"></span>
                        <h3>Speleologie</h3>
