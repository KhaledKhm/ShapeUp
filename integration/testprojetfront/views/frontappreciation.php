...
// list of results (of the row 1 in this case)
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <form action="frontajouterAppreciation.php" method="POST">
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  ...
                  -->
                    <input type="hidden" class="form-control" id="c_fname" name="idAppreciation" placeholder="générée automatiquement" value="" readonly>
                <!--
                  </div>
                -->
...
<tr>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <textarea type="text" name="texteAppreciation" id="c_message" cols="30" rows="7" class="form-control" required=""></textarea>
                  </div>
                </div>
...
<div class="rate">
    ...
    <label for="star1" title="1">1 star</label>
                  ...
                  <div class="col-md-6">
                    <label for="c_lname" class="text-black">Votre Cin <span class="text-danger">*</span></label>
                  <input type="number" name="cinUtilisateur" readonly value="<?PHP echo $_SESSION['c'] ?>">
                  </div>
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" name="ajouter" value="ajouter votre appréciation" onclick="numero()">&nbsp;&nbsp;
                  </div>
                </div>
              </div>   
            </div>
      ...
      <div class="container">
       <div class="col-md-7">
          <form action="frontafficherAppreciation.php" method="POST">
            <div class="form-group row">
              <div class="col-lg-12">
                <input type="submit" class="btn btn-primary btn-lg btn-block" name="afficher" value="consulter vos appréciations">
                  </div>
                </div>
              </div>
            </div>
