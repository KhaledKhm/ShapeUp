...
//$listeAppreciationsFront=$appreciation1C->afficherAppreciationsFront();
...
<html lang="en">
  <head>
    <title>Shape-Up &mdash; Appreciations</title>
    <meta charset="utf-8">
...
<!-- ******************************************************************** -->
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Vos Appréciations</h2>
          </div>
          <table class="table table-striped">
    <tr>
        <td>Id Appreciation</td>
        <td>Commentaire</td>
        <td>Note</td>
        <td>Cin</td>
        <td>supprimer</td>
    ...
    foreach($listeAppreciations as $row){
        ...
        <tr>
            ...
            <td><form method="POST" action="frontsupprimerAppreciation.php">
                    <input type="submit" name="supprimer" value="supprimer">
                    <input type="hidden" value="<?PHP echo $row['idAppreciation']; ?>" name="idAppreciation">
                </form>
            </td>
            <td><a href="frontmodifierAppreciation.php?idAppreciation=<?PHP echo $row['idAppreciation']; ?>">
                    Modifier</a></td>
        </tr>
        <?PHP
    }
    ?>
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                  <a href="frontappreciation.php" class="mt-5 btn btn-primary btn-block text-uppercase">
