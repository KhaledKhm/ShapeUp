...
class promotionC{
	 function recupererproduitsenpromotion(){
        $sql="SELECT prod.img,prod.libelleP,prod.quantite,prod.prix,prom.tauxPromotion,prom.descriptionPromotion,prom.datedepartPromotion,prom.datefinPromotion from produit as prod INNER JOIN promotion as prom ON prod.code=prom.idProduit";
