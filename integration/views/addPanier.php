...
<!--end here-->
    <div class="site-section">
      <div class="container">
          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h1 class="text-black h5">Welcome to our store</h1></div>
                <div class="d-flex">
        ...
        ?>
        <a href="produits.php ?code=<?php echo $row['code']; ?>">
          ...
          ?>
                  ...
                  <div class="block-4-text p-4">
                    <h3><a href=""><?php echo $row['libelleP']; ?></a></h3>

                    <p class="text-primary font-weight-bold"><a href=""><?php echo $row['prix']; ?>DT</a></p>
                    <input type="number" value="1" required="true" name="quantite" style="text-align:center;"/> 
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <ul class="list-unstyled mb-0">
                <li class="mb-1"><a href="musculation.html" class="d-flex"><span>Musculation</span> <span class="text-black ml-auto"></span></a></li>
                <li class="mb-1"><a href="cardio.html" class="d-flex"><span>Fitness et Cardio training</span> <span class="text-black ml-auto"></span></a></li>
                <li class="mb-1"><a href="cross.html" class="d-flex"><span>Fitness et Cross training</span> <span class="text-black ml-auto"></span></a></li>
              </ul>
            </div>
         ...
         <!-- <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
           ...
           <div class="col-md-6 col-lg-3">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
            <li class="address">ChotranaIII,La soukra Rue Des Fruits ,Ariana </li>
